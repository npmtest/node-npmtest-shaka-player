...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-shaka-player/node_modules/shaka-player/externs/shaka/manifest_parser.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-shaka-player/node_modules/shaka-player/externs/shaka/manifest_parser.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-shaka-player/node_modules/shaka-player/externs/shaka/</a> &#187; manifest_parser.js</div>
</div>
<div class="body">
 ...
 * @exportDoc
 */
shakaExtern.ManifestParser = <span class="fstat-no" title="function not covered" >function() {</span>};
&nbsp;
&nbsp;
/**
 ...
 * @exportDoc
 */
<span class="cstat-no" title="statement not covered" >shakaExtern.ManifestParser.Factory;</span>
&nbsp;
&nbsp;
/**
 ...
 * @exportDoc
 */
<span class="cstat-no" title="statement not covered" >shakaExtern.ManifestParser.prototype.configure = <span class="fstat-no" title="function not covered" >function(config) {</span>};</span>
&nbsp;
&nbsp;
/**
 ...
 * @exportDoc
 */
<span class="cstat-no" title="statement not covered" >shakaExtern.ManifestParser.prototype.start =</span>
<span class="fstat-no" title="function not covered" >    function(uri, networkingEngine, filterPeriod, onError, onEvent) {</span>};
&nbsp;
&nbsp;
/**
 ...
 * @exportDoc
 */
<span class="cstat-no" title="statement not covered" >shakaExtern.ManifestParser.prototype.stop = <span class="fstat-no" title="function not covered" >function() {</span>};</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
